...
{
    [DbContext(typeof(DbContextGeral))]
    [Migration("20190424021649_PessoaTipo")]
    partial class PessoaTipo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Vendas.Bebida", b =>
                {
                    b.Property<int>("BebidaId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<bool>("BebidaPrefierida");
                    ...
                    b.Property<string>("MineDescricao");
            ...
            modelBuilder.Entity("Domain.Entities.Vendas.Categoria", b =>
                {
                    b.Property<int>("CategoriaId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Domain.Entities.Vendas.Bebida", b =>
                {
                    b.HasOne("Domain.Entities.Vendas.Categoria", "Categoria")
                        .WithMany("Bebidas")
