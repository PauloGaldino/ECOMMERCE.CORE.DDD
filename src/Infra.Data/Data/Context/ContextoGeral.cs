...
{
    public class DbContextGeral : DbContext
    {
      

        public DbContextGeral(DbContextOptions<DbContextGeral> options) : base(options)
        {

        }

        public DbContextGeral()
        {
        }
        ...
        {
            string strCon = "Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=aspnet-ECOMMERCE.UI.TCC;Integrated Security=False;Connect Timeout=15;Encrypt=False;TrustServerCertificate=False";
